...
# Función para el click de los botones
...
# Función para revisar los checkbox
def revisar_check():
    x = 0
...
def recibo():
    ...
    # Para sacar el nombre y el precio de los productos
    x = 0
...
# Función para guardar el recibo en un archivo de texto en el ordenador
def guardar():
...
# Función para resetear toda la pantalla
def resetear():
    # Borrar recibo
    texto_recibo.delete(0.1, END)

    # Borrar pcantidades y ponerlos a 0
    ...
    # Para vaciar los cuadros de abajo
...
# Panel Costos
panel_costos = Frame(panel_izquierdo, bd=1, bg="azure4", padx=50, relief=FLAT)
...
# listas de productos
lista_comidas = ["Carne", "Cordero", "Pollo", "Salmón", "Merluza", "Pizza1", "Pizza2", "Pizza3"]
lista_bebidas = ["Agua", "Soda", "Cola", "vino1", "Vino2", "Cerveza1", "cerveza2", "Jugo"]
